		...
		<>
			...
			<AppBar color='primary'>
				<Toolbar>
					...
					<Button variant='text' color='inherit' onClick={() => history.push('/')}>Salir </Button>
				</Toolbar>
			</AppBar>
			...
			<footer className={classes.footer}>
				<Container maxWidth='sm'>
					<Typography align='center'>PokeDexIvan  edgar.ivanmagallanes@gmail.com {new Date().getFullYear()}</Typography>
				</Container>
			</footer>
		</>
	)
